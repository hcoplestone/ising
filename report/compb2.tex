...
\begin{figure}[t]
    \centering
    \subfloat[Average magnetisation per spin]{{\includegraphics[width=8.11cm]{images/section2/magnetisation.png} }}\quad
     \subfloat[Average dimensionless energy per spin]{{\includegraphics[width=8.11cm]{images/section2/energy.png} }}\
